...
struct upower_tbl upower_tbl_l_B24G = {
	.row = {
		{.cap = 147, .volt = 45000, .dyn_pwr = 17036,
			.lkg_pwr = {24481, 24481, 24481, 24481, 24481, 24481} },
		{.cap = 181, .volt = 45000, .dyn_pwr = 22147,
			.lkg_pwr = {24481, 24481, 24481, 24481, 24481, 24481} },
		{.cap = 193, .volt = 46250, .dyn_pwr = 24883,
			.lkg_pwr = {25289, 25289, 25289, 25289, 25289, 25289} },
		{.cap = 203, .volt = 47500, .dyn_pwr = 27778,
			.lkg_pwr = {26096, 26096, 26096, 26096, 26096, 26096} },
		{.cap = 221, .volt = 50000, .dyn_pwr = 34063,
			.lkg_pwr = {27712, 27712, 27712, 27712, 27712, 27712} },
		{.cap = 239, .volt = 52500, .dyn_pwr = 41033,
			.lkg_pwr = {29541, 29541, 29541, 29541, 29541, 29541} },
		{.cap = 249, .volt = 54375, .dyn_pwr = 46751,
			.lkg_pwr = {30913, 30913, 30913, 30913, 30913, 30913} },
		{.cap = 264, .volt = 56250, .dyn_pwr = 52357,
			.lkg_pwr = {32406, 32406, 32406, 32406, 32406, 32406} },
		{.cap = 285, .volt = 60000, .dyn_pwr = 64430,
			.lkg_pwr = {35513, 35513, 35513, 35513, 35513, 35513} },
		{.cap = 302, .volt = 62500, .dyn_pwr = 73144,
			.lkg_pwr = {37853, 37853, 37853, 37853, 37853, 37853} },
		{.cap = 310, .volt = 65000, .dyn_pwr = 82433,
			.lkg_pwr = {40194, 40194, 40194, 40194, 40194, 40194} },
		{.cap = 324, .volt = 69375, .dyn_pwr = 97153,
			.lkg_pwr = {44828, 44828, 44828, 44828, 44828, 44828} },
		{.cap = 335, .volt = 72500, .dyn_pwr = 108403,
			.lkg_pwr = {48490, 48490, 48490, 48490, 48490, 48490} },
		{.cap = 340, .volt = 74375, .dyn_pwr = 115373,
			.lkg_pwr = {50739, 50739, 50739, 50739, 50739, 50739} },
		{.cap = 350, .volt = 77500, .dyn_pwr = 127431,
			.lkg_pwr = {54885, 54885, 54885, 54885, 54885, 54885} },
		{.cap = 356, .volt = 80000, .dyn_pwr = 137463,
			.lkg_pwr = {58280, 58280, 58280, 58280, 58280, 58280} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_cluster_l_B24G = {
	.row = {
		{.cap = 147, .volt = 45000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 181, .volt = 45000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 193, .volt = 46250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 203, .volt = 47500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 221, .volt = 50000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 239, .volt = 52500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 249, .volt = 54375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 264, .volt = 56250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 285, .volt = 60000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 302, .volt = 62500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 310, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 324, .volt = 69375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 335, .volt = 72500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 340, .volt = 74375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 350, .volt = 77500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 356, .volt = 80000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,

...
struct upower_tbl upower_tbl_l_B24G = {
	.row = {
		{.cap = 147, .volt = 55000, .dyn_pwr = 17036,
			.lkg_pwr = {24481, 24481, 24481, 24481, 24481, 24481} },
		{.cap = 181, .volt = 55000, .dyn_pwr = 22147,
			.lkg_pwr = {24481, 24481, 24481, 24481, 24481, 24481} },
		{.cap = 193, .volt = 56250, .dyn_pwr = 24883,
			.lkg_pwr = {25289, 25289, 25289, 25289, 25289, 25289} },
		{.cap = 203, .volt = 57500, .dyn_pwr = 27778,
			.lkg_pwr = {26096, 26096, 26096, 26096, 26096, 26096} },
		{.cap = 221, .volt = 60000, .dyn_pwr = 34063,
			.lkg_pwr = {27712, 27712, 27712, 27712, 27712, 27712} },
		{.cap = 239, .volt = 62500, .dyn_pwr = 41033,
			.lkg_pwr = {29541, 29541, 29541, 29541, 29541, 29541} },
		{.cap = 249, .volt = 64375, .dyn_pwr = 46751,
			.lkg_pwr = {30913, 30913, 30913, 30913, 30913, 30913} },
		{.cap = 264, .volt = 66250, .dyn_pwr = 52357,
			.lkg_pwr = {32406, 32406, 32406, 32406, 32406, 32406} },
		{.cap = 285, .volt = 70000, .dyn_pwr = 64430,
			.lkg_pwr = {35513, 35513, 35513, 35513, 35513, 35513} },
		{.cap = 302, .volt = 72500, .dyn_pwr = 73144,
			.lkg_pwr = {37853, 37853, 37853, 37853, 37853, 37853} },
		{.cap = 310, .volt = 75000, .dyn_pwr = 82433,
			.lkg_pwr = {40194, 40194, 40194, 40194, 40194, 40194} },
		{.cap = 324, .volt = 79375, .dyn_pwr = 97153,
			.lkg_pwr = {44828, 44828, 44828, 44828, 44828, 44828} },
		{.cap = 335, .volt = 82500, .dyn_pwr = 108403,
			.lkg_pwr = {48490, 48490, 48490, 48490, 48490, 48490} },
		{.cap = 340, .volt = 84375, .dyn_pwr = 115373,
			.lkg_pwr = {50739, 50739, 50739, 50739, 50739, 50739} },
		{.cap = 350, .volt = 87500, .dyn_pwr = 127431,
			.lkg_pwr = {54885, 54885, 54885, 54885, 54885, 54885} },
		{.cap = 356, .volt = 90000, .dyn_pwr = 137463,
			.lkg_pwr = {58280, 58280, 58280, 58280, 58280, 58280} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_cluster_l_B24G = {
	.row = {
		{.cap = 147, .volt = 55000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 181, .volt = 55000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 193, .volt = 56250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 203, .volt = 57500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 221, .volt = 60000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 239, .volt = 62500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 249, .volt = 64375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 264, .volt = 66250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 285, .volt = 70000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 302, .volt = 72500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 310, .volt = 75000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 324, .volt = 79375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 335, .volt = 82500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 340, .volt = 84375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 350, .volt = 87500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 356, .volt = 90000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_b_B24G = {
	.row = {
		{.cap = 611, .volt = 55000, .dyn_pwr = 88853,
			.lkg_pwr = {103988, 103988, 103988, 103988, 103988,
				103988} },
		{.cap = 667, .volt = 58125, .dyn_pwr = 113084,
			.lkg_pwr = {112290, 112290, 112290, 112290, 112290,
				112290} },
		{.cap = 697, .volt = 59375, .dyn_pwr = 125369,
			.lkg_pwr = {115611, 115611, 115611, 115611, 115611,
				115611} },
		{.cap = 732, .volt = 61875, .dyn_pwr = 147605,
			.lkg_pwr = {122886, 122886, 122886, 122886, 122886,
				122886} },
		{.cap = 754, .volt = 63750, .dyn_pwr = 164400,
			.lkg_pwr = {128501, 128501, 128501, 128501, 128501,
				128501} },
		{.cap = 753, .volt = 65625, .dyn_pwr = 186497,
			.lkg_pwr = {134355, 134355, 134355, 134355, 134355,
				134355} },
		{.cap = 797, .volt = 70000, .dyn_pwr = 233693,
			.lkg_pwr = {149134, 149134, 149134, 149134, 149134,
				149134} },
		{.cap = 836, .volt = 73750, .dyn_pwr = 282870,
			.lkg_pwr = {163420, 163420, 163420, 163420, 163420,
				163420} },
		{.cap = 864, .volt = 76875, .dyn_pwr = 327217,
			.lkg_pwr = {176240, 176240, 176240, 176240, 176240,
				176240} },
		{.cap = 893, .volt = 80000, .dyn_pwr = 374804,
			.lkg_pwr = {189670, 189670, 189670, 189670, 189670,
				189670} },
		{.cap = 931, .volt = 83750, .dyn_pwr = 443644,
			.lkg_pwr = {207838, 207838, 207838, 207838, 207838,
				207838} },
		{.cap = 952, .volt = 86875, .dyn_pwr = 505112,
			.lkg_pwr = {224138, 224138, 224138, 224138, 224138,
				224138} },
		{.cap = 978, .volt = 89375, .dyn_pwr = 556944,
			.lkg_pwr = {237797, 237797, 237797, 237797, 237797,
				237797} },
		{.cap = 995, .volt = 91250, .dyn_pwr = 597446,
			.lkg_pwr = {248913, 248913, 248913, 248913, 248913,
				248913} },
		{.cap = 1011, .volt = 93125, .dyn_pwr = 646701,
			.lkg_pwr = {260465, 260465, 260465, 260465, 260465,
				260465} },
		{.cap = 1024, .volt = 95000, .dyn_pwr = 697760,
			.lkg_pwr = {272017, 272017, 272017, 272017, 272017,
				272017} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
...
struct upower_tbl upower_tbl_cluster_b_B24G = {
	.row = {
		{.cap = 611, .volt = 55000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 667, .volt = 58125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 697, .volt = 59375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 732, .volt = 61875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 754, .volt = 63750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 753, .volt = 65625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 797, .volt = 70000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 836, .volt = 73750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 864, .volt = 76875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 893, .volt = 80000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 931, .volt = 83750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 952, .volt = 86875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 978, .volt = 89375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 995, .volt = 91250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 1011, .volt = 93125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },

 ...
 * }
 */
#define FIXED_VSRAM_VOLT                (55000)
#define FIXED_VSRAM_VOLT_THSRESHOLD     (55000)
...
#define VSRAM_GPU_MIN_VOLT              (30000)         /* mV x 100 */
...
#define GPU_ACT_REF_FREQ                (1070000)              /* KHz */
...
enum g_segment_id_enum {
	MT6833_SEGMENT = 1,
	MT6833M_SEGMENT,
	MT6833T_SEGMENT,		//Reserve Segment. Mediatek Dimensity 810 use MT6833P aka MT6833T.
};
...
struct opp_table_info g_opp_table_segment_1[] = {
	GPUOP(1068000, 77000, 77000, POSDIV_POWER_2, 1875), /* 0 sign off */
	GPUOP(1059000, 76375, 76375, POSDIV_POWER_2, 1875), /* 1 */
	GPUOP(1051000, 75750, 75750, POSDIV_POWER_2, 1875), /* 2 */
	GPUOP(1042000, 75125, 75125, POSDIV_POWER_2, 1875), /* 3 */
	GPUOP(1034000, 74500, 74500, POSDIV_POWER_2, 1875), /* 4 */
	GPUOP(1025000, 73875, 73875, POSDIV_POWER_2, 1875), /* 5 */
	GPUOP(1017000, 73250, 73250, POSDIV_POWER_2, 1875), /* 6 */
	GPUOP(1008000, 72625, 72625, POSDIV_POWER_2, 1875), /* 7 */
	GPUOP(1000000, 72000, 72000, POSDIV_POWER_2, 1875), /* 8 sign off */
	GPUOP(985000,  71375, 71375, POSDIV_POWER_2, 1875), /* 9 */
	GPUOP(970000,  70750, 70750, POSDIV_POWER_2, 1875), /*10 */
	GPUOP(955000,  70125, 70125, POSDIV_POWER_2, 1875), /*11 */
	GPUOP(940000,  69500, 69500, POSDIV_POWER_4, 1875), /*12 */
	GPUOP(925000,  68875, 68875, POSDIV_POWER_4, 1875), /*13 */
	GPUOP(910000,  68250, 68250, POSDIV_POWER_4, 1875), /*14 */
	GPUOP(895000,  67625, 67625, POSDIV_POWER_4, 1875), /*15 */
	GPUOP(880000,  67000, 67000, POSDIV_POWER_4, 1875), /*16 sign off */
	GPUOP(868000,  66375, 67000, POSDIV_POWER_4, 1875), /*17 */
	GPUOP(857000,  65750, 67000, POSDIV_POWER_4, 1875), /*18 */
	GPUOP(846000,  65125, 67000, POSDIV_POWER_4, 1875), /*19 */
	GPUOP(835000,  64500, 67000, POSDIV_POWER_4, 1250), /*20 */
	GPUOP(823000,  63875, 67000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(812000,  63250, 67000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(801000,  62625, 67000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(790000,  62000, 67000, POSDIV_POWER_4, 1250), /*24 */
	GPUOP(778000,  61375, 67000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(767000,  60750, 67000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(756000,  60125, 67000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(745000,  59500, 67000, POSDIV_POWER_4, 1250), /*28 */
	GPUOP(733000,  58875, 67000, POSDIV_POWER_4, 1250), /*29 */
	GPUOP(722000,  58250, 67000, POSDIV_POWER_4, 1250), /*30 */
	GPUOP(711000,  57625, 67000, POSDIV_POWER_4, 1250), /*31 */
	GPUOP(700000,  57000, 67000, POSDIV_POWER_4, 1250), /*32 sign off */
	GPUOP(674000,  56375, 67000, POSDIV_POWER_4, 1250), /*33 */
	GPUOP(648000,  55750, 67000, POSDIV_POWER_4, 1250), /*34 */
	GPUOP(622000,  55125, 67000, POSDIV_POWER_4, 1250), /*35 */
	GPUOP(596000,  54500, 67000, POSDIV_POWER_4,  625), /*36 */
	GPUOP(570000,  53875, 67000, POSDIV_POWER_4,  625), /*37 */
	GPUOP(545000,  53250, 67000, POSDIV_POWER_4,  625), /*38 */
	GPUOP(519000,  52625, 67000, POSDIV_POWER_4,  625), /*39 */
	GPUOP(493000,  52000, 67000, POSDIV_POWER_4,  625), /*40 */
	GPUOP(467000,  51375, 67000, POSDIV_POWER_4,  625), /*41 */
	GPUOP(441000,  50750, 67000, POSDIV_POWER_4,  625), /*42 */
	GPUOP(415000,  50125, 67000, POSDIV_POWER_4,  625), /*43 */
	GPUOP(390000,  49500, 67000, POSDIV_POWER_4,  625), /*44 sign off */
};
...
struct opp_table_info g_opp_table_segment_3[] = {
	GPUOP(1068000, 65000, 65000, POSDIV_POWER_2, 1875), /* 0 sign off */
	GPUOP(1059000, 64375, 64375, POSDIV_POWER_2, 1875), /* 1 */
	GPUOP(1051000, 63750, 63750, POSDIV_POWER_2, 1875), /* 2 */
	GPUOP(1042000, 63125, 63125, POSDIV_POWER_2, 1875), /* 3 */
	GPUOP(1034000, 62500, 62500, POSDIV_POWER_2, 1875), /* 4 */
	GPUOP(1025000, 61875, 61875, POSDIV_POWER_2, 1875), /* 5 */
	GPUOP(1017000, 61250, 61250, POSDIV_POWER_2, 1875), /* 6 */
	GPUOP(1008000, 60625, 60625, POSDIV_POWER_2, 1875), /* 7 */
	GPUOP(1000000, 60000, 60000, POSDIV_POWER_2, 1875), /* 8 sign off */
	GPUOP(985000,  59375, 59375, POSDIV_POWER_2, 1875), /* 9 */
	GPUOP(970000,  58750, 58750, POSDIV_POWER_2, 1875), /*10 */
	GPUOP(955000,  58125, 58125, POSDIV_POWER_2, 1875), /*11 */
	GPUOP(940000,  57500, 57500, POSDIV_POWER_4, 1875), /*12 */
	GPUOP(925000,  56875, 56875, POSDIV_POWER_4, 1875), /*13 */
	GPUOP(910000,  56250, 56250, POSDIV_POWER_4, 1875), /*14 */
	GPUOP(895000,  55625, 55625, POSDIV_POWER_4, 1875), /*15 */
	GPUOP(880000,  55000, 55000, POSDIV_POWER_4, 1875), /*16 sign off */
	GPUOP(868000,  54375, 55000, POSDIV_POWER_4, 1875), /*17 */
	GPUOP(857000,  53750, 55000, POSDIV_POWER_4, 1875), /*18 */
	GPUOP(846000,  53125, 55000, POSDIV_POWER_4, 1875), /*19 */
	GPUOP(835000,  52500, 55000, POSDIV_POWER_4, 1250), /*20 */
	GPUOP(823000,  51875, 55000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(812000,  51250, 55000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(801000,  50625, 55000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(790000,  50000, 55000, POSDIV_POWER_4, 1250), /*24 */
	GPUOP(778000,  49375, 55000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(767000,  48750, 55000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(756000,  48125, 55000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(745000,  47500, 55000, POSDIV_POWER_4, 1250), /*28 */
	GPUOP(733000,  46875, 55000, POSDIV_POWER_4, 1250), /*29 */
	GPUOP(722000,  46250, 55000, POSDIV_POWER_4, 1250), /*30 */
	GPUOP(711000,  45625, 55000, POSDIV_POWER_4, 1250), /*31 */
	GPUOP(700000,  45000, 55000, POSDIV_POWER_4, 1250), /*32 sign off */
	GPUOP(674000,  45000, 55000, POSDIV_POWER_4, 1250), /*33 */
	GPUOP(648000,  45000, 55000, POSDIV_POWER_4, 1250), /*34 */
	GPUOP(622000,  44375, 55000, POSDIV_POWER_4, 1250), /*35 */
	GPUOP(596000,  44375, 55000, POSDIV_POWER_4,  625), /*36 */
	GPUOP(570000,  44375, 55000, POSDIV_POWER_4,  625), /*37 */
	GPUOP(545000,  43750, 55000, POSDIV_POWER_4,  625), /*38 */
	GPUOP(519000,  43750, 55000, POSDIV_POWER_4,  625), /*39 */
	GPUOP(493000,  43750, 55000, POSDIV_POWER_4,  625), /*40 */
	GPUOP(467000,  43125, 55000, POSDIV_POWER_4,  625), /*41 */
	GPUOP(441000,  43125, 55000, POSDIV_POWER_4,  625), /*42 */
	GPUOP(415000,  43125, 55000, POSDIV_POWER_4,  625), /*43 */
	GPUOP(390000,  42500, 55000, POSDIV_POWER_4,  625), /*44 sign off */
};

...
struct opp_table_info g_opp_table_segment_3[] = {
	GPUOP(1068000, 70000, 70000, POSDIV_POWER_2, 1875), /* 0 sign off */
	GPUOP(1059000, 69375, 69375, POSDIV_POWER_2, 1875), /* 1 */
	GPUOP(1051000, 68750, 68750, POSDIV_POWER_2, 1875), /* 2 */
	GPUOP(1042000, 68125, 68125, POSDIV_POWER_2, 1875), /* 3 */
	GPUOP(1034000, 67500, 67500, POSDIV_POWER_2, 1875), /* 4 */
	GPUOP(1025000, 66875, 66875, POSDIV_POWER_2, 1875), /* 5 */
	GPUOP(1017000, 66250, 66250, POSDIV_POWER_2, 1875), /* 6 */
	GPUOP(1008000, 65625, 65625, POSDIV_POWER_2, 1875), /* 7 */
	GPUOP(1000000, 65000, 65000, POSDIV_POWER_2, 1875), /* 8 sign off */
	GPUOP(985000,  64375, 64375, POSDIV_POWER_2, 1875), /* 9 */
	GPUOP(970000,  63750, 63750, POSDIV_POWER_2, 1875), /*10 */
	GPUOP(955000,  63125, 63125, POSDIV_POWER_2, 1875), /*11 */
	GPUOP(940000,  62500, 62500, POSDIV_POWER_4, 1875), /*12 */
	GPUOP(925000,  61875, 61875, POSDIV_POWER_4, 1875), /*13 */
	GPUOP(910000,  61250, 61250, POSDIV_POWER_4, 1875), /*14 */
	GPUOP(895000,  60625, 60625, POSDIV_POWER_4, 1875), /*15 */
	GPUOP(880000,  60000, 60000, POSDIV_POWER_4, 1875), /*16 sign off */
	GPUOP(868000,  59375, 60000, POSDIV_POWER_4, 1875), /*17 */
	GPUOP(857000,  58750, 60000, POSDIV_POWER_4, 1875), /*18 */
	GPUOP(846000,  58125, 60000, POSDIV_POWER_4, 1875), /*19 */
	GPUOP(835000,  57500, 60000, POSDIV_POWER_4, 1250), /*20 */
	GPUOP(823000,  56875, 60000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(812000,  56250, 60000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(801000,  55625, 60000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(790000,  55000, 60000, POSDIV_POWER_4, 1250), /*24 */
	GPUOP(778000,  54375, 60000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(767000,  53750, 60000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(756000,  53125, 60000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(745000,  52500, 60000, POSDIV_POWER_4, 1250), /*28 */
	GPUOP(733000,  51875, 60000, POSDIV_POWER_4, 1250), /*29 */
	GPUOP(722000,  51250, 60000, POSDIV_POWER_4, 1250), /*30 */
	GPUOP(711000,  50625, 60000, POSDIV_POWER_4, 1250), /*31 */
	GPUOP(700000,  50000, 60000, POSDIV_POWER_4, 1250), /*32 sign off */
	GPUOP(674000,  50000, 60000, POSDIV_POWER_4, 1250), /*33 */
	GPUOP(648000,  50000, 60000, POSDIV_POWER_4, 1250), /*34 */
	GPUOP(622000,  49375, 60000, POSDIV_POWER_4, 1250), /*35 */
	GPUOP(596000,  49375, 60000, POSDIV_POWER_4,  625), /*36 */
	GPUOP(570000,  49375, 60000, POSDIV_POWER_4,  625), /*37 */
	GPUOP(545000,  48750, 60000, POSDIV_POWER_4,  625), /*38 */
	GPUOP(519000,  48750, 60000, POSDIV_POWER_4,  625), /*39 */
	GPUOP(493000,  48750, 60000, POSDIV_POWER_4,  625), /*40 */
	GPUOP(467000,  48125, 60000, POSDIV_POWER_4,  625), /*41 */
	GPUOP(441000,  48125, 60000, POSDIV_POWER_4,  625), /*42 */
	GPUOP(415000,  48125, 60000, POSDIV_POWER_4,  625), /*43 */
	GPUOP(390000,  47500, 60000, POSDIV_POWER_4,  625), /*44 sign off */
};
